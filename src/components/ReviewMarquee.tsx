...
import { Star, MapPin, ChevronDown, ChevronUp, ChevronLeft, ChevronRight, LayoutGrid, Play, CheckCircle2, X } from 'lucide-react';
...
const reviews: Review[] = [
...

  {
    ...
    tag: { en: "Supportive", np: "आश्वस्त पार्ने" }
      ...
      <div className="flex-grow">
        ...
        {!showFull && (
          <div 
            ...
            aria-hidden="true"
          >
            <span>{isExpanded ? (language === 'en' ? "Read Less" : "थोरै पढ्नुहोस्") : (language === 'en' ? "Read More" : "थप पढ्नुहोस्")}</span>
            {isExpanded ? (
...
const ReviewMarquee: React.FC = () => {
  ...
  // Duplicate reviews to create a seamless loop for marquee
